...
def delete_quiz_cascade(db: Session, quiz: models.Quiz) -> None:
    """Delete a quiz along with any attempts that reference it
    (questions cascade automatically via the ORM relationship)."""
